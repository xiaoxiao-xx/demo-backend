...
public class AsyncTask3 {
	...
	@Autowired
	public AsyncTask3(HttpTemplate httpTemplate, MaterialService materialService,
	...
	public void rec(String materialId, FaceSdkRecVo faceSdkRec) {
		...
		// 保存人脸识别结果
		CaptureTask2.DetectResult2 result2 = gson.fromJson(ret2, CaptureTask2.DetectResult2.class);

		List<CaptureTask2.FaceInfo> faces2 = result2.getData().getResult();
		if (faces2 == null) {
