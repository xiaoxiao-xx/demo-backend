...
public class AsyncTask2 {
	...
	@Autowired
	public AsyncTask2(HttpTemplate httpTemplate, MaterialService materialService,
	 ...
	 */
	@Async
	public void detect(byte[] image, String materialId, FaceSdkRecVo faceSdkRecVo) {
...
//			byte[] bytes = ImageUtil.cut(image, x, y, width, height);
			...
			// 保存人脸识别结果
			CaptureTask2.DetectResult result2 = gson.fromJson(ret2, CaptureTask2.DetectResult.class);

			List<CaptureTask2.FaceInfo> faces2 = result2.getFaces();
			if (faces2 == null) {
