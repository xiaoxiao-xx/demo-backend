...
public class AlarmStrategyController {
	...
	@GetMapping("query")
	public ResultVo<PageInfo<PsmAlarmStrategyVo>> query(@RequestParam(name = "pageIndex") Integer pageIndex,
            @RequestParam(name = "pageSize") Integer pageSize){
		return ResultVo.ok(alarmStrategyService.query(pageIndex, pageSize));
	}
